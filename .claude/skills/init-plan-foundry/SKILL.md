...
- Retired/ exists
- .gitignore contains entries for Retired/, Workbench/.heartbeat/, and `.claude` (per D10 — the target's .claude is gitignored because it's a symlink into the home bundle, not target-tracked content)
