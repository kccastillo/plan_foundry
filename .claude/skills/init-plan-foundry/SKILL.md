...
- Retired/ exists.
- .gitignore contains entries for `Retired/`, `Workbench/.heartbeat/`, `.plan-foundry-tmp/`, `.claude/skills/`, `.claude/agents/`, `.claude/commands/`, `.claude/hooks/`, `.claude/.plan-foundry-bundle-version`, `.claude/_foundry_log.jsonl`.
