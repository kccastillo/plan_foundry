...
In prose rather than instructions, 'good' reads as though you have received it from someone who knows the material and is interested in helping you understand. Sentence lengths are uneven. Nothing clears its throat before starting. Claims sit at the strength the evidence supports, hedged where genuinely uncertain and stated flatly where not. The same thing carries the same name from the first page to the last.
