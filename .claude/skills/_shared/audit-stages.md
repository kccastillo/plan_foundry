...
kind: helper
title: Audit Stages
topic_tags: [audit, stages, ideate, sufficiency, plan-safety]
description: Three-tier audit stage distinction (Self-Critique, Spec-Refine sufficiency, plan-safety) defining the bounded focus of each stage so reviewers do not duplicate work.
discoverable_via: [ideate-clarify, audit-sufficiency, audit-haiku-safe, manual]
created: 2026-05-26
last_consulted: ""
consulted_by: []
schema_version: 1
