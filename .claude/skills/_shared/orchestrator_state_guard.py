...
OWNED_FIELDS = (
    ...
    "verification_state",
    "total_loop_attempts",  # PLAN-AH1 - cross-session IAL guard; Routine-managed.
                            # NOT zeroed on drafted-revert (unlike audit_state).
                            # Default 0; orchestrator-managed; ceiling 10.
)
