...
Covers build_block and apply_operating_rules_block across all branches,
including wrapping fidelity, create, append, skip, replace, and the
malformed-marker FAIL cases.

All fixtures use synthetic, distinctive operating-rules text (D4) so that
the tests remain independent of the live operating-rules.md content.
"""
...
# Add the _shared directory to sys.path so that the import below resolves
