...
**Core requirement:** Phases 1–3 remain core-optional (preserve existing behaviour without plan-foundry-core). Phases 4–8 **require** `plan-foundry-core` plugin (severity-surface library, plan-template frontmatter, dispatch.md routing).
