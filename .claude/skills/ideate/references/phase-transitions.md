...
|---|---|---|---|
| (none / empty) | `risk_assess_idea` (at Converge close - Gate A fires first) | `clarify` / `survey` / `converge` (in-conversation loops; no disk state) | Write RESEARCH/ADVICE; ideate ends |
