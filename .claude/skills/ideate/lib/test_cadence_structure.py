...
Run with: python -m pytest .claude/skills/ideate/lib/test_cadence_structure.py
"""
...
CADENCE_PHASES = (
    REPO_ROOT / ".claude" / "skills" / "ideate" / "workflows" / "cadence-phases.md"
)
IDEATE_SKILL = (
    REPO_ROOT / ".claude" / "skills" / "ideate" / "SKILL.md"
)
RESEARCH_TEMPLATE = (
    REPO_ROOT / ".claude" / "skills" / "_shared" / "research-prompt-template.md"
)
