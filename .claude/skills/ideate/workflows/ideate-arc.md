...
**Entry condition:** Human has invoked ideation with a seed problem, question, or topic, AND has picked `full arc` at Gate 0. See [../../_shared/proportionality-gate.md](../../_shared/proportionality-gate.md). A lower rung ends the arc here.
