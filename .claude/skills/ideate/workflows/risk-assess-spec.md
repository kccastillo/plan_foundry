...
Gate output artefact lifecycle: `Workbench/.ideate-gate/<plan-id>-gate-b.json` is written on a clean pass and cleaned up after Self-Critique completes. See `cadence-phases.md §Gate B` for the authoritative lifecycle note.
