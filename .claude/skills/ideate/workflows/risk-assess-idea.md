...
Gate output artefact lifecycle: `Workbench/.ideate-gate/<plan-id>-gate-a.json` is written on a clean pass and cleaned up after Spec-Draft completes. See `cadence-phases.md §Gate A` for the authoritative lifecycle note.
