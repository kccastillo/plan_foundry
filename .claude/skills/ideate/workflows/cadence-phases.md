...
**Core requirement.** Phases 4–8 require the plan_foundry bundle (Workbench/, write-plan, plan-pipeline). Without it, ideate behaves exactly as the three-phase arc (phases 1–3 only), terminating at Phase 3 with plain markdown or an ADVICE file. Detection at the Converge→Spec-Draft boundary.
