...
2. **Auto-dispatch threshold (≥2 Real-judgement-call clusters):** If 2 or more Real-judgement-call clusters were identified, the orchestrator auto-dispatches one general-purpose research agent per cluster. Each agent:
   - Model: sonnet
