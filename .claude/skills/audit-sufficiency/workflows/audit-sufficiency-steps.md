...
```json
{
  ...
  "payload": {
    ...
    "triaged_human_items": [
      ...
      { "class": "mechanically_forced", "item": "..." },
      { "class": "already_locked", "item": "..." }
    ]
  },
