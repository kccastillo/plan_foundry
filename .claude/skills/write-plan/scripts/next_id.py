...
For PLAN:
    ...
    file found under Workbench/ and Retired/. Rolled-over LOGs nest in
    per-month subdirectories of Retired/, so Retired/ is scanned recursively.
    The filesystem (Workbench/ and Retired/) is consulted as a belt-and-braces
    secondary source.
