...
- **Recurring Task Tracker** - RECUR PLANs, their cadence, last-done, next-due. Stays LOG-side because INDEX is regenerated on every commit and has no `last-done` write-back path (per AB9 D4 and ADVICE-006 section 3).
