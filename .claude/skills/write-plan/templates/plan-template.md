...
ideate_phase: ""             # enum; empty for ad-hoc PLANs not produced via ideate cadence
                             # values: clarify|survey|converge|spec_draft|self_critique|spec_refine|cross_spec_reconcile|consolidate|complete|exited_early
...
ideate_iteration_count:      # bounded loop counters (orchestrator-incremented; hard limit on self_critique = 5)
