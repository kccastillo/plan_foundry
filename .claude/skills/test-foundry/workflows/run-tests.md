...
2. Writes `Workbench/testreports/TESTREPORT-NNN_<slug>.md` with the schema described in [`../../templates/testreport.md`](../templates/testreport.md) if present, else inline (see Step 6 reference structure below).
