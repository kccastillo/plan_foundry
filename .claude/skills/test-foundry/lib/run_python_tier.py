...
def main(argv: list[str] | None = None) -> int:
    ...
    # Post-PLAN-AC3: resolve repo root from cwd (where the human invoked the
    # harness), not from this script's __file__ — which previously walked
    # parents and could land in a different repo when the bundle is symlinked
    # into a target via ~/.claude/plan_foundry. The harness now lives at
