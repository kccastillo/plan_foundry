...
Verify the retire-skill post-condition: a PLAN passed to `retire` is **moved** (not deleted) to `Retired/`. Mirrors the section 4F post-condition gate that caught the PLAN-AA2 retire-bug.
