...
`.plan-foundry-bundle-files` recording the audited path in receipt-relative form as
...
Verdict `bundle_managed`, on the signal `.plan-foundry-bundle-files records this
