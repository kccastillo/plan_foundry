...
- The seven deprecation shims carried descriptions that still described the work they no
  longer did, each prefixed "Deprecated". The bundle no longer ships them: they were
  removed on 2026-08-16, so they no longer sit in the listing.

## Retirement candidates

The seven shim-only skills the deprecation ledger recorded were removed on 2026-08-16,
ahead of the major they had been scheduled for. Each carried a shim body only, and the
ledger named a replacement for each. Their listing cost is no longer spent, and the
deprecation ledger no longer records them.
