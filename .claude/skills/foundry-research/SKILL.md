...
**Fable is used nowhere. Opus appears only at synthesis.** No fan-out role may escalate to Fable - rule 2 of [../_shared/fable-escalation-policy.md](../_shared/fable-escalation-policy.md) forbids it inside a fan-out categorically, independent of the per-role pins below. See [references/model-tiering.md](references/model-tiering.md) for the full rationale and the cross-cutting principle (the same tier-by-role discipline applies to any role-homogeneous fan-out - judge panels, review/bughunter swarms).
