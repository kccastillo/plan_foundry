...
KEEP: actionable next steps; human-only decisions that gate them; constraints whose violation causes harm; where artifacts live.
...
Absorb what is useful, discard what is useless. Delete any section below that has no actionable content (except Next steps).
-->
...
1. {THE FIRST CONCRETE ACTION — a command, an edit, a decision to execute. Ordered. This section is the spine; it is never empty.}
2. {NEXT ACTION...}
