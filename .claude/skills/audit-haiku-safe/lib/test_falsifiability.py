...
8 tests covering the scenarios specified in PLAN-AB5 Step 5.
All tests use synthetic fixtures (tempfile.TemporaryDirectory + synthetic PLAN
content). No live repo files are read.

Run with:
    python -m pytest plugins/plan-foundry-core/skills/audit-haiku-safe/lib/test_falsifiability.py
