...
The owned-field set guarded by the snapshot/restore mechanism: `pipeline_phase`, `audit_state`, `last_executor_outcome`, `verification_state` (status excluded — see D1 above).
