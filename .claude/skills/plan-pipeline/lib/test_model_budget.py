...
Recalibration doctrine:
  ...
  - plan-safety-auditor  -> opus   (recalibrated 2026-08-03: a revision_needed
                                     return should carry enough for the next
                                     iteration to succeed, not just flag mechanically)
