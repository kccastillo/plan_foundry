...
def test_example_a():
    ...
    expect_contains(prompt, "[STUCK x2]", "A: STUCK badge on E1")
...
def test_example_c():
    ...
    diagnostics = {
        ...
        "details": [
            ...
            "  - S104 @ step 7 [STUCK x3]: test fidelity ambiguity",
            "  - S203 @ step 12 [STUCK x3]: missing acceptance: on script-producing step",
    ...
    expect_contains(prompt, "STUCK x3", "C: STUCK badge in diagnostics")
