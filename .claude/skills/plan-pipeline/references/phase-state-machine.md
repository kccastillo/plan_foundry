...
Stale threshold: `last_tick_at` > 10 minutes ago AND `phase != exited` → surface warning. Full spec: `plugins/plan-foundry-core/skills/execute-plan/references/heartbeat-spec.md`.
