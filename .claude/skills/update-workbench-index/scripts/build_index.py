...
def get_recent_retires(repo_root: Path, max_count: int = 10) -> list:
    ...
    machines (Retired/ is gitignored and absent in CI).
...
def render_markdown(
    ...
    # not from Retired/ filesystem (gitignored and absent in CI). Matches
    # commit messages with "retire PLAN-" or "plan-pipeline: retired".
