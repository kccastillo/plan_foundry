...
model: sonnet
description: Foreground research subagent dispatched during ideate Survey Phase 2.B. Pinned to Sonnet for light-judgement prior-art retrieval - cheaper than the inherited frontier session model, per ADVICE-014 lever 2 (PLAN-AE7). Reads mandatory sub-questions from .claude/skills/_shared/research-prompt-template.md and returns a <=400-word cited cluster summary ending in a Verdict line.
---
