...
Exception conditions: this agent is invoked before sufficiency-auditor passed (returns `outcome: exception`), the PLAN file is unreadable, or the referenced source `.claude/skills/_shared/plan-safe.md` is missing.
