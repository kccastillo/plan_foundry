...
- Mobile and web Claude Code apps DO read project-local `.claude/{skills,agents,commands}/` once the bundle is copied in - this is exactly the use case AC6 enables. Operating rules inlined into CLAUDE.md are visible across all surfaces.
