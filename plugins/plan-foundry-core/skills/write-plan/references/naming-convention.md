...
The canonical allocator is `plugins/plan-foundry-core/skills/write-plan/scripts/next_id.py`. It issues AA-form IDs for PLAN, numeric for ADVICE/RESEARCH. Source of truth: LOG primary, filesystem secondary, warn-and-union on disagreement. See PLAN-AA1's Decision Classification for design lineage.
