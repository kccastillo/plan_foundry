...
**Push policy (PLAN-AB1).** Before any `git push`, the orchestrator reads the effective push policy:

```python
from plugins.plan_foundry_core.skills._shared.push_policy import get_push_policy
